...
from torchvision.models import Wide_ResNet101_2_Weights,ResNeXt101_32X8D_Weights
...
def get_argparse():
    ...
    parser.add_argument('-o', '--output_folder',
                        default='output/pretraining/25/')
    return parser.parse_args()

# variables
model_size = 'medium'
imagenet_train_path = '/data0/mhxu/data/ILSVRC2012_img_train'
seed = 3407
